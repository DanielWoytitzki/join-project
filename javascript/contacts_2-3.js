...
function contactsCheckRequiredEditContact() {
  ...
  if (document.getElementById("editName").value == "") {
    ...
    document
      .getElementById("contactsEditNameRequired")
  ...
  if (emailValue == "" || !emailValue.includes("@")) {
    ...
    document
      .getElementById("contactsEditEmailRequired")
      .classList.remove("d-none");
  ...
  if (document.getElementById("editPhone").value == "") {
    ...
    document
      .getElementById("contactsEditPhoneRequired")
      .classList.remove("d-none");
...
function saveEditedContactMobile(contactId) {
  ...
  if (required) {
    ...
    let newEmail = document.getElementById("editEmail").value;
    let newPhone = document.getElementById("editPhone").value;
    let color = document.querySelector(".contact-big-profile-img-mobile").style
      .backgroundColor; // Fetch the current color
