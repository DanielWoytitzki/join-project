 ...
 */
function contactsCheckRequiredEditContact() {
  let requiredEditName = false;
  let requiredEditEmail = false;
  let requiredEditPhone = false;

  if (document.getElementById("editName").value == "") {
    document.getElementById("editName").classList.add("red-border");
    document.getElementById("contactsEditNameRequired").classList.remove("d-none");
  } else if (!document.getElementById("editName").value == "") {
    document.getElementById("editName").classList.remove("red-border");
    document.getElementById("contactsEditNameRequired").classList.add("d-none");
    requiredEditName = true;
  }

  const emailValue = document.getElementById("editEmail").value;

  if (emailValue == "" || !emailValue.includes("@")) {
    document.getElementById("editEmail").classList.add("red-border");
    document.getElementById("contactsEditEmailRequired").classList.remove("d-none");
  } else if (!document.getElementById("editEmail").value == "") {
    document.getElementById("editEmail").classList.remove("red-border");
    document.getElementById("contactsEditEmailRequired").classList.add("d-none");
    requiredEditEmail = true;
  }

  if (document.getElementById("editPhone").value == "") {
    document.getElementById("editPhone").classList.add("red-border");
    document.getElementById("contactsEditPhoneRequired").classList.remove("d-none");
  } else if (!document.getElementById("editPhone").value == "") {
    document.getElementById("editPhone").classList.remove("red-border");
    document.getElementById("contactsEditPhoneRequired").classList.add("d-none");
    requiredEditPhone = true;
  }

  let required = false;

  if (requiredEditName && requiredEditEmail && requiredEditPhone) {
    required = true;
  }
  return required;
}
                          ...
                          <div>
                              <div class="input-fields-add-contact">
                                <div class="required-input">
                                  ...
                                  <div id="contactsEditNameRequired" class="required-input-msg d-none">This field is required.</div>
                                </div>
                                <div class="required-input">
                                  <input id="editEmail" style="background-image: url('./img/mail-icon.svg');" type="email" value="${email}" placeholder="E-Mail" required>
                                  <div id="contactsEditEmailRequired" class="required-input-msg d-none">This field is required. Don't forget to add "@".</div>
                                </div>
                                <div class="required-input">
                                  <input id="editPhone" style="background-image: url('./img/call-icon.svg');" type="number" value="${phone}" placeholder="Phone" required>
                                  <div id="contactsEditPhoneRequired" class="required-input-msg d-none">This field is required.</div>
                                </div>
                              </div>
                          </div>
                          <div class="buttons-add-contact">
...
function saveEditedContact(contactId) {
  let required = contactsCheckRequiredEditContact();
